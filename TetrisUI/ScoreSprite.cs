...
namespace TetrisUI
{
    public class ScoreSprite : DrawableGameComponent
    {
        ...
        {
            spriteBatch.Begin();
            spriteBatch.DrawString(font, "Level: " + score.Level, new Vector2(220, 100), Color.White);
            spriteBatch.DrawString(font, "Score: " + score.GameScore, new Vector2(220, 120), Color.White);
            spriteBatch.DrawString(font, "Lines Cleared: " + score.Lines, new Vector2(220, 140), Color.White);
            base.Draw(gameTime);
            spriteBatch.End();
        }
    }
