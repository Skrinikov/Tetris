...
namespace TetrisUnitTest
{
    ...
    {
        [TestMethod]
        public void ShapeTLengthTest()
        {

            IBoard b = new Board();
            IShape shape = new ShapeT(b);
        ...
        [TestMethod]
        public void ShapeTIndexerTest_working()
        {
            IBoard b = new Board();
            IShape shape = new ShapeT(b);
        ...
        public void ShapeTIndexerTest_exception()
        {
            IBoard b = new Board();
            IShape shape = new ShapeT(b);
        ...
        [TestMethod]
        public void ShapeTMoveLeftTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeT(b);
        ...
        [TestMethod]
        public void ShapeTMoveRightTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeT(b);
        ...
        [TestMethod]
        public void ShapeTMoveDownTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeT(b);
