...
namespace TetrisUnitTest
{
    ...
    {
        [TestMethod]
        public void ShapeILengthTest()
        {

            IBoard b = new Board();
            IShape shape = new ShapeI(b);
        ...
        [TestMethod]
        public void ShapeIIndexerTest_working()
        {
            IBoard b = new Board();
            IShape shape = new ShapeI(b);
        ...
        public void ShapeIIndexerTest_exception()
        {
            IBoard b = new Board();
            IShape shape = new ShapeI(b);
        ...
        [TestMethod]
        public void ShapeIMoveLeftTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeI(b);
        ...
        [TestMethod]
        public void ShapeIMoveRightTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeI(b);
        ...
        [TestMethod]
        public void ShapeIMoveDownTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeI(b);
