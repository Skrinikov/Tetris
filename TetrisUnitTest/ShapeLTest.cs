...
namespace TetrisUnitTest
{
    ...
    {
        [TestMethod]
        public void ShapeLLengthTest()
        {

            IBoard b = new Board();
            IShape shape = new ShapeL(b);
        ...
        [TestMethod]
        public void ShapeLIndexerTest_working()
        {
            IBoard b = new Board();
            IShape shape = new ShapeL(b);
        ...
        public void ShapeLIndexerTest_exception()
        {
            IBoard b = new Board();
            IShape shape = new ShapeL(b);
        ...
        [TestMethod]
        public void ShapeLMoveLeftTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeL(b);
        ...
        [TestMethod]
        public void ShapeLMoveRightTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeL(b);
        ...
        [TestMethod]
        public void ShapeLMoveDownTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeL(b);
        ...
        public void ShapeLRotateTest()
        {
            ...
            Assert.AreEqual(p2, new Point(a2.X - 2, a2.Y - 0));
            Assert.AreEqual(p3, new Point(a3.X + 1, a3.Y - 1));
            //Second Rotation
            Assert.AreEqual(a0, b0);
            Assert.AreEqual(a1, new Point(b1.X - 1, b1.Y - 1));
            Assert.AreEqual(a2, new Point(b2.X + 0, b2.Y - 2));
            Assert.AreEqual(a3, new Point(b3.X + 1, b3.Y + 1));
            //Third Rotation
            Assert.AreEqual(b0, b0);
            Assert.AreEqual(b1, new Point(c1.X + 1, c1.Y - 1));
            Assert.AreEqual(b2, new Point(c2.X + 2, c2.Y + 0));
            Assert.AreEqual(b3, new Point(c3.X - 1, c3.Y + 1));
            //Forth Rotation
            Assert.AreEqual(c0, d0);
            Assert.AreEqual(c1, new Point(d1.X + 1, d1.Y + 1));
            Assert.AreEqual(c2, new Point(d2.X - 0, d2.Y + 2));
            Assert.AreEqual(c3, new Point(d3.X - 1, d3.Y - 1));
        }

        [TestMethod]
        public void ShapeLResetTest()
        {
            IBoard b = new Board();
            IShape shape = new ShapeL(b);
